...
-- AddForeignKey
ALTER TABLE `Peminjaman` ADD CONSTRAINT `Peminjaman_id_barang_fkey` FOREIGN KEY (`id_barang`) REFERENCES `Iventaris`(`id_barang`) ON DELETE RESTRICT ON UPDATE CASCADE;
